...
<form action="jsjlList.do" name="myform" method="post">
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                          <tr>
                            ...
                            <td align="center" bgcolor='#ebf0f7'>教练编号</td>
    <td align="center" bgcolor='#ebf0f7'>教练姓名</td>
    <td align="center" bgcolor='#ebf0f7' width='40' align='center'>性别</td>
    <td align="center" bgcolor='#ebf0f7'>专长</td>
    <td align="center" bgcolor='#ebf0f7' width='90' align='center'>照片</td>
    ...
    <td>${u.dizhi}</td>
                              ...
                              <td align="center"><a href="jsjlDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="jsjlList.do?page=1" >首页</a>
             <a href="jsjlList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="jsjlList.do?page=${page.page+1 }">下一页</a>
			<a href="jsjlList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
