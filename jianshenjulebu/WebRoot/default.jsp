...
<div class="content">
	...
	<div class="wrap">
		...
		<div class="pad20">
			<div class="title">
				<div class="name name2"><h3>健身新闻</h3>News</div>
				<div class="more"><a href="xwtzList.do?lb=健身新闻">更多 ></a></div>
			</div>
			<div class="f4_x"></div>
			<div class="wwdt">
				<div class="l_pic"><a href="xwtzList.do?lb=健身新闻"><img src="qtimages/news.jpg" width="288" height="188" /></a><a href="xwtzList.do?lb=健身新闻">所有资讯,这里都有,快来看看！</a>				</div>
				<div class="c_news">
					...
					<a href="xwtzList.do?lb=健身新闻" class="more">更多动态</a>
				</div>
				<div class="r_tw">
      ...
      cellPadding=0 cellSpacing=5>
		...
		<div class="pad20 slideGroup">
			<div class="title">
				<div class="name name2"><h3>教练风采</h3>Products</div>
				<div class="more"><a href="jsjlList.do">更多 ></a></div>
				<div class="clear"></div>
			</div>
		  ...
		  <div class="parBd">
				<div class="slideBox">
					...
					<ul>
					 ...
					 <c:forEach items="${syjianshenjiaolian1 }" var="a">
						<li>
							<div class="pic"><a href="jsjlDetail.do?id=${a.id}" target="_blank"><img src="${a.zhaopian}" width="300" height="300" border="0" /></a></div>
							<div class="tit"><a href="jsjlDetail.do?id=${a.id}" target="_blank">${a.jiaolianxingming}</a><span class="eye">${a.zhuanchang}</span></div>
						</li>
