	...
	<body>
			<form action="addAllusers.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<tr ><td width="200">用户名：</td><td><input name='username' type='text' id='username' value='' onblur='hsgcheck()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelusername' /></td></tr>
		<tr ><td width="200">密码：</td><td><input name='pwd' type='text' id='pwd' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelpwd' /></td></tr>
...
function hsgcheck() {
		...
		if(username==""||(username.length<3||username.length>12)){
			 $("#clabelusername").html("username不能为空且长度在3～12位之间！");
