...
<form action="kcyyList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.kechengmingcheng}</td>    <td>${u.shangkeshijian}</td>    <td>${u.yonghuming}</td>    
                              ...
                              <td align="center"><a href="kcyyDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="kcyyList.do?page=1" >首页</a>
             <a href="kcyyList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="kcyyList.do?page=${page.page+1 }">下一页</a>
			<a href="kcyyList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
