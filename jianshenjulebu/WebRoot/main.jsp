...
<div class="bodywrapper">
    <div class="topheader">
        <div class="left">
            <h1 class="logo"><span>健身俱乐部会员管理系统</span></h1>
        ...
        <div class="right">
			...
			<font color="white">当前用户：<%=request.getSession().getAttribute("username")%>&nbsp;&nbsp;权限：<%=request.getSession().getAttribute("cx")%></font>
                     	</div>  <a href="logout.jsp" onClick="return confirm('确定要退出？')">&nbsp;&nbsp;<font color="white">退出</font></a> <a href="index.jsp" >&nbsp;&nbsp;<font color="white">首页</font></a>
           <!--userinfo-->
...
<div class="userdata">
    ...
    <div class="header">
    	<ul class="headermenu">
            ...
            <li><a href="allusersList.do" target="main"><span class="icon icon-pencil"></span>管理员用户</a></li>
