...
public class IndexController {
	...
	@Resource
	private JianshenjiaolianServer jianshenjiaolianServer;
	//jixacxishxu3
...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		List<Jianshenjiaolian> syjianshenjiaolian1=jianshenjiaolianServer.getsyjianshenjiaolian1(null);
		//jixacxishxu4
	    ...
	    map.put("syyonghuzhuce1", syyonghuzhuce1);
		 map.put("syjianshenjiaolian1", syjianshenjiaolian1);
	    //jixacxishxu5
